...
def __desktop_icon_setting():
    ...
    en = GConfEntry(_('Set "Computer" name:'), '/apps/nautilus/desktop/computer_icon_name',
            _('Set the icon name of "My Computer"to Whatever you like') )
    table.attach(en, 1, 2, 2, 3, gtk.FILL, gtk.FILL)
    ...
    en = GConfEntry(_('Set "Home folder" name:'), '/apps/nautilus/desktop/home_icon_name',
            _('Set the icon name of "My Folder" to Whatever you like'))
    table.attach(en, 1, 2, 3, 4, gtk.FILL, gtk.FILL)
    ...
    en = GConfEntry(_('Set "Network server" name:'), '/apps/nautilus/desktop/network_icon_name',
            _('Set the icon name of "Network server" to Whatever you like'))
    table.attach(en, 1, 2, 4, 5, gtk.FILL, gtk.FILL)
    ...
    en = GConfEntry(_('Set "Trash" name:'), '/apps/nautilus/desktop/trash_icon_name',
            _('Set the icon name of "Trash" to Whatever you like'))
    table.attach(en, 1, 2, 5, 6, gtk.FILL, gtk.FILL)
